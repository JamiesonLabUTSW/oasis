...
This publication includes project information, guided tours, recorded demonstrations, and the technical report. Each tour explains what data it uses and whether anything was connected live. It does not yet include application source code, binaries, installation packages, sample datasets, or a tagged software release; any future release will state exactly what it contains and which terms apply.
