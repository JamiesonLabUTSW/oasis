...
text with large language models. Model execution is provider-flexible, with
support for hosted services and compatible local endpoints such as vLLM.
Modality-aware execution, provenance capture, and human review keep scores
inspectable from rubric definition through adjudication.
